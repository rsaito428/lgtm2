...
FONT_NAME = '/Libarary/Fonts/Arial Bold.ttf'
...
def save_with_message(fp, message):
    ...
    for font_size in range(FONT_MAX_SIZE, FON_MIN_SIZE, -1):
        ...
        if w > 0 and h > 0:
            position = ((image_width - text_height)/2, (image_height - text_height)/2)
